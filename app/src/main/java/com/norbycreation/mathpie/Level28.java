        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level28Hint = new Intent(getApplicationContext(), Level28Hint.class);
                        startActivity(level28Hint);
            ...
            rewardedAd.show(Level28.this, rewardedAdCallback);
        } else {
...
//        This id is a Test id please ensure to add real one before publishing;
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 28</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 28</font>");
        }
    }
}