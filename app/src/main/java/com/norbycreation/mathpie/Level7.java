        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level7Hint = new Intent(getApplicationContext(), Level7Hint.class);
                        startActivity(level7Hint);
                        editTextAnswer.setText("13");
                        earn = false;
                    }

                }
            };
            rewardedAd.show(Level7.this, rewardedAdCallback);
        } else {

            //        This id is a Test id please ensure to add real one before publishing;
            rewardedAd = new RewardedAd(this, "ca-app-pub-2808567025402378/1926742455");
            loadRewardedAd();
...
//        This id is a Test id please ensure to add real one before publishing;
    ...
    void share() {
        ...
        Bitmap bm = BitmapFactory.decodeResource(this.getResources(), R.drawable.level_7_share);
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 7</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 7</font>");
        }
    }
}