...
public class Level110 extends AppCompatActivity {
...
//                    finish();
                    Intent congratulations = new Intent(getApplicationContext(), Congratulations.class);
        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level110Hint = new Intent(getApplicationContext(), Level110Hint.class);
                        startActivity(level110Hint);
            ...
            rewardedAd.show(Level110.this, rewardedAdCallback);
        } else {
...
//            I have called show() first then getButton(..) other wise it will throw null pointer;
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 110</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 110</font>");
        }
    }
}