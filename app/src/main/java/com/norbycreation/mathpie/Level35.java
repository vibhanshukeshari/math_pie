        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level35Hint = new Intent(getApplicationContext(), Level35Hint.class);
                        startActivity(level35Hint);
            ...
            rewardedAd.show(Level35.this, rewardedAdCallback);
        } else {
...
//        This id is a Test id please ensure to add real one before publishing;
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 35</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 35</font>");
        }
    }
}