        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level18Hint = new Intent(getApplicationContext(), Level18Hint.class);
                        startActivity(level18Hint);
                        editTextAnswer.setText("8");
                        earn = false;
                    }

                }
            };
            rewardedAd.show(Level18.this, rewardedAdCallback);
        } else {


//        This id is a Test id please ensure to add real one before publishing;
            rewardedAd = new RewardedAd(this, "ca-app-pub-2808567025402378/8964113468");
            loadRewardedAd();
...
//        This id is a Test id please ensure to add real one before publishing;
    ...
    void share() {
        ...
        Bitmap bm = BitmapFactory.decodeResource(this.getResources(), R.drawable.level_18_share);
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 18</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 18</font>");
        }
    }
}