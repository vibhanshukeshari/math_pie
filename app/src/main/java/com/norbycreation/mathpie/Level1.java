...
//
//                            image_view_correct.setBackgroundResource(R.drawable.correct_animation);
//
//                            break;
//
...
//                            this is helper text shows below the edit text but i have turned it off because it extends the layout size that is why;
...
//                            textInputLayout.setHintTextColor(ColorStateList.valueOf(ContextCompat.getColor(getApplicationContext(), R.color.red_opacity_eighty_percent)));
        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level1Hint = new Intent(getApplicationContext(), Level1Hint.class);
                        startActivity(level1Hint);
                        editTextAnswer.setText("9");
                        earn = false;
                    }

                }
            };
            rewardedAd.show(Level1.this, rewardedAdCallback);
        } else {
            rewardedAd = new RewardedAd(this, "ca-app-pub-2808567025402378/9792155574");
            loadRewardedAd();
...
//        loadRewardedAd();
    ...
    void share() {
        ...
        Bitmap bm = BitmapFactory.decodeResource(this.getResources(), R.drawable.level_1_share);
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 1</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 1</font>");
        }
    }
}