...
public class Level74 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level74);
        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level74Hint = new Intent(getApplicationContext(), Level74Hint.class);
                        startActivity(level74Hint);
            ...
            rewardedAd.show(Level74.this, rewardedAdCallback);
        } else {
...
//            I have called show() first then getButton(..) other wise it will throw null pointer;
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 74</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 74</font>");
        }
    }
}