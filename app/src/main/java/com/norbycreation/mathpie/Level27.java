        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level27Hint = new Intent(getApplicationContext(), Level27Hint.class);
                        startActivity(level27Hint);
            ...
            rewardedAd.show(Level27.this, rewardedAdCallback);
        } else {
...
//        This id is a Test id please ensure to add real one before publishing;
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 27</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 27</font>");
        }
    }
}