...
public class Level88 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level88);
        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level88Hint = new Intent(getApplicationContext(), Level88Hint.class);
                        startActivity(level88Hint);
            ...
            rewardedAd.show(Level88.this, rewardedAdCallback);
        } else {
...
//            I have called show() first then getButton(..) other wise it will throw null pointer;
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 88</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 88</font>");
        }
    }
}