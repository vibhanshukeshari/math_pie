...
public class Level41 extends AppCompatActivity {
        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level41Hint = new Intent(getApplicationContext(), Level41Hint.class);
                        startActivity(level41Hint);
            ...
            rewardedAd.show(Level41.this, rewardedAdCallback);
        } else {
            ...
            builder.setMessage("Ad is not loaded, Please try again in few seconds.");
...
//            I have called show() first then getButton(..) other wise it will throw null pointer;
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 41</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 41</font>");
        }
    }
}