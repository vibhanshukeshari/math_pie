...
public class Level84 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level84);
        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level84Hint = new Intent(getApplicationContext(), Level84Hint.class);
                        startActivity(level84Hint);
            ...
            rewardedAd.show(Level84.this, rewardedAdCallback);
        } else {
...
//            I have called show() first then getButton(..) other wise it will throw null pointer;
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 84</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 84</font>");
        }
    }
}