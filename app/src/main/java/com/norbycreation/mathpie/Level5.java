        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level5Hint = new Intent(getApplicationContext(), Level5Hint.class);
                        startActivity(level5Hint);
            ...
            rewardedAd.show(Level5.this, rewardedAdCallback);
        } else {

            //        This id is a Test id please ensure to add real one before publishing;
            rewardedAd = new RewardedAd(this, "ca-app-pub-2808567025402378/3459315971");
            loadRewardedAd();
...
//            I have called show() first then getButton(..) other wise it will throw null pointer;
    ...
    void share() {
        ...
        Bitmap bm = BitmapFactory.decodeResource(this.getResources(), R.drawable.level_5_share);
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 5</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 5</font>");
        }
    }
}