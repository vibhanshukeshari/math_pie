        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level16Hint = new Intent(getApplicationContext(), Level16Hint.class);
                        startActivity(level16Hint);
                        editTextAnswer.setText("7");
                        earn = false;
                    }

                }
            };
            rewardedAd.show(Level16.this, rewardedAdCallback);
        } else {


//        This id is a Test id please ensure to add real one before publishing;
            rewardedAd = new RewardedAd(this, "ca-app-pub-2808567025402378/4094930167");
            loadRewardedAd();
...
//        This id is a Test id please ensure to add real one before publishing;
    ...
    void share() {
        ...
        Bitmap bm = BitmapFactory.decodeResource(this.getResources(), R.drawable.level_16_share);
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 16</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 16</font>");
        }
    }
}