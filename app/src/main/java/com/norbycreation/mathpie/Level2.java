        ...
        if (rewardedAd.isLoaded()) {
            rewardedAdCallback = new RewardedAdCallback() {
                ...
                public void onRewardedAdClosed() {
                    ...
                    if (earn) {
                        Intent level2Hint = new Intent(getApplicationContext(), Level2Hint.class);
                        startActivity(level2Hint);
            ...
            rewardedAd.show(Level2.this, rewardedAdCallback);
        } else {

            //        This id is a Test id please ensure to add real one before publishing;
            rewardedAd = new RewardedAd(this, "ca-app-pub-2808567025402378/5155541027");
            loadRewardedAd();
...
//            I have called show() first then getButton(..) other wise it will throw null pointer;
    ...
    void share() {
        ...
        Bitmap bm = BitmapFactory.decodeResource(this.getResources(), R.drawable.level_2_share);
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 2</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 2</font>");
        }
    }
}