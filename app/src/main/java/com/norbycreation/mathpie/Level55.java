...
public class Level55 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level55);
...
//                            this is helper text shows below the edit text but i have turned it off because is extends the layout size that is why;
    ...
    private void showRewardedAd() {
        if (rewardedAd.isLoaded()) {
            ...
            rewardedAd.show(Level55.this, rewardedAdCallback);
        } else {
...
//            I have called show() first then getButton(..) other wise it will throw null pointer;
    ...
    Spanned htmlTextWhiteMenuBack() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            return Html.fromHtml("<font color='#cfcfcf'>Level 55</font>", Html.FROM_HTML_MODE_LEGACY);
        } else {
            return Html.fromHtml("<font color='#cfcfcf'>Level 55</font>");
        }
    }
}