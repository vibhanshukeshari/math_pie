...
public class Congratulations extends AppCompatActivity {
    ...
    Button mainMenu, challenge, rateUs, restart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(Congratulations.this, R.style.MyDialogTheme);
...
//                                Clearing all cookies and catches;
    ...
    void share() {
        ...
        String text = "Math Pie - Boost your IQ, Memory, Attention, Accuracy, And Logic Skills with 110+" +
